    ...
    <div class="row">
      <div class="col-md-4"  style="background-color:white;border-radius:20px;margin-left:130px;margin-top:40px;height:500px;">
        <div class="container" >
          <div class="row">
            <div class="col">
              <h2 style="text-align:center;padding-top:20px;color:blue;border-bottom:2px solid blue;">Available Furniture Types
              </h2>
              <div class="container">
                <div class="row">
                  <div class="col" style="text-align:center;padding-top:30px;">
                    <?php $query="select * from furnituretype";?>
                    <a href="furnituredisplay.php?all='1'">
                      <H4 style="border-bottom:2px solid blue;padding:20px;">All Furnitures
                        </h4>
                    </a>
                    <?php $result=mysqli_query($con,$query);
while($data=mysqli_fetch_array($result)){
?>
                    <a href="furnituredisplay.php?type=<?php echo $data[0]?>">
                      <H4 style="border-bottom:2px solid blue;padding:20px;">
                        <?php echo $data[1]?>
                        </h4>
                    </a>
                    <?php }?>
      ...
      <div class="container" style="padding-top:30px;">
        <div class="col-md-8" style="background-color:white;border-radius:20px;padding-top:30px;">
          <h3 style="color:blue;" class="slideshow" style="text-align:center;font-family:'system-ui';">
            <?php echo $purchase;?>
          </h3>
          <h3 class="slideshow" style="text-align:center;font-family:'system-ui';">Available  Sales
          </h3>
          <div class="row">
            <div class="col-md-12">
...
?>
                <div class="img_box">
                  ...
                  <h6 class="price">
                    <?php echo "Name:".$data[1];?>
                  </h6>
                  <h5 class="price">
                    <?php echo "Price:".$data[3]."$";?>
                  </h5>
                  <?php if(isset($_SESSION['user'])){?>
                  <h6 class="price"> 
                    <a href="purchasefurniture.php?id=<?php echo $data[0];?>" >See More
                      </h6>
                    </a>
                  <?php }else{?>
                  <h6 class="price">
                    <a href="#" data-target="#login-modal" data-toggle="modal">
                      <h6 class="price">See More
                      </h6>
                    </a>
                    <?php }?>
                    </div>

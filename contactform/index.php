...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
	...
	<li class="nav-item active">
	  <a style="color:black;font-family: "system-ui";" class="nav-link" href="furnituredisplay.php">Furniture Products<span class="sr-only">(current)</span></a>
	</li>

	<li class="nav-item active">
	  <a style="color:black;font-family: "system-ui";" class="nav-link" href="contactform/index.php">Contact Us<span class="sr-only">(current)</span></a>
	</li>
   ...
   <button type="button" class="btn btn-primary">Search</button>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="https://formspree.io/nyeinyadanartun2001@gmail.com/index.html" method="POST">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<input  id="email" class="input100" type="email" name="_replyto" placeholder="Eg. example@email.com">
					<span class="focus-input100"></span>
				</div>

...
if(isset($_REQUEST['add'])  ){
  ...
  if($flag==false){
    ...
    $_SESSION['furnitureprice'][$i]=$_REQUEST['furnitureprice'];
    $_SESSION['furniturename'][$i]=$_REQUEST['furniturename'];
     $_SESSION['furnitureimage'][$i]=$_REQUEST['furnitureimage'];
    
  }
  }
  $purchase="Successfully Save Furniture";
...
<div class="modal-footer">
  <div class="row">
 <div class="col-sm-6"><button type="submit" class="btn btn-primary btn-lg btn-block" id="singin"><a href="" style="color:white;">Login</a></button></div>
 ...
 <div class="row">
 <div class="col-md-4"  style="background-color:white;border-radius:20px;margin-left:130px;margin-top:40px;height:500px;">
 <div class="container" >
 <div class="row">
 <div class="col">
...
<a href="furnituredisplay.php?all='1'"><H4 style="border-bottom:2px solid blue;padding:20px;">All Furnitures</h4></a>
<?php $result=mysqli_query($con,$query);
while($data=mysqli_fetch_array($result)){
    ?>

<a href="furnituredisplay.php?type=<?php echo $data[0]?>"><H4 style="border-bottom:2px solid blue;padding:20px;"><?php echo $data[1]?></h4></a>
<?php }?>
</div></div>
</div>
 </div>
 ...
 <h3 style="color:blue;" class="slideshow" style="text-align:center;font-family:'system-ui';"><?php echo $purchase;?></h3>
...
<?php if(isset($_SESSION['user'])){?>
  <h6 class="price"> <a href="purchasefurniture.php?id=<?php echo $data[0];?>" >See More</h6></a>
<?php }else{?>
  <h6 class="price">
   <a href="#" data-target="#login-modal" data-toggle="modal"><h6 class="price">See More</h6></a>
<?php }?>
   </div>
  <?php }?>
...
<?php }else{?>
  ...
  <h6 class="price"> <a href="#" data-target="#login-modal" data-toggle="modal"><h6 class="price">See More</h6></a>
<?php }?>
   </div>
  <?php
}
